...
헤이딜러는 네임드 오픈소스 컨트리뷰터, **상권** 안드로이드 개발자께서 홍보를 하셨습니다. 안드로이드 팀은 3명이여서 코드 리뷰와 Jira, 컨플루언스, A/B 테스트 등을 도입하고 있다고 했습니다. 반면 아이폰 재직 개발자는 1인이기 때문에, 3년차급이나 5년차 이상급의 아이폰 개발자를 채용하고 있다고 합니다.
